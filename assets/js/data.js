const data = [{
  ...
  },
  {
    ...
    englishText: 'This is not how I imagined the catastrophe. No. <br>I imagined hell breaking lose, storms of fire and ice, and us– running far and fast and wild<br>I imagined sieges, and ruins, and floods <br>running through blood and mud <br>without being able to stop. <br>I did not imagine we will be ordered to stay still. <br><br>I imagined a ready packed bag, straight out of disaster films, with water and ammo and guns<br>I imagined terrible weather or a horrible storm, not the fresh spring breeze through my lungs <br>I imagined that when asked not to move–it would not be from the living room couch<br>And that when we need food–it would not be ready and made in such huge amounts. <br><br>This is not how I imagined the catastrophe. <br><br>I imagined that everything would be covered in blood, not sterile to the bone<br>I imagined bodies rolling abound, and kids yelling around <br>Instead, the cities are empty, and children laugh deep inside their homes– <br>I imagined bombs. And rockets. And famine. And wars. <br>I imagined all the horrors, and worse– <br>But I thought that at least we will be together. <br>I did not think whether<br>I would be able to hug, all of those I truly care about. <br><br>This is not how I imagined the catastrophe,<br>but it is already here. <br>So maybe it is time to stop being scared–and start imagining, all over again.',
    hebrewText: 'לא ככה דמיינתי את הקטסטרופה. לא. <br>דמיינתי תופת ומרדף ובריחה – <br>שנברח כמה שיותר מהר וכמה שיותר רחוק,<br>דמיינתי אש או מבול או מצור<br>שנרוץ ונרוץ ולא נוכל לעצור,<br>לא דמיינתי שנצטרך רק לעצור. <br><br>דמיינתי תיק של סרטי אסונות, עם נשק ומים ומלא מתים מסביב, <br>דמיינתי כפור אימים או חמסין נוראי, לא את הימים היפים של תחילת האביב, דמיינתי שאם נתבקש לא לזוז, זה בטח לא יהיה על הספה בסלון <br>ושכשנצטרך אוכל, הוא לא יהיה ערוך ומוכן בכמויות בארון – <br>לא ככה דמיינתי את הקטסטרופה. <br><br>דמיינתי שהכל יהיה מגואל בדם, לא סטרילי עד אימה<br>דמיינתי גופות מתגוללות ברחובות, וילדים צועקים<br>במקום - הרחובות ריקים, והילדים צוחקים – רק בחדרי חדרים.<br>דמיינתי את כל הזוועות שיש, באמת. אבל חשבתי שלפחות נהיה יחד. כולם. לא האמנתי שלא אוכל לחבק את מי שהכי חשובים לי בכל העולם. <br><br>לא ככה דמיינתי את הקטסטרופה, אבל היא כבר כאן.<br>אז אולי זה הזמן להפסיק לפחד – ולהתחיל לדמיין מחדש.<br><br>',
